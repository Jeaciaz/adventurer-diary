...
import { Badge, Card, Counter, NumberStepper, RadioGroup } from '../ui';
    ...
    <div class="flex flex-col gap-4">
      ...
      <Card>
        <div class="flex flex-wrap items-end gap-4">
          <div>
            <div class="text-xs uppercase opacity-60">Ранг</div>
            <Badge variant="primary" outline class="mt-1 text-base">
              {rank().ru}
            </Badge>
          </div>
          <NumberStepper
      ...
      <Card>
        ...
        <div class="mt-2 flex flex-wrap gap-2">
          ...
          <Counter label="Навыки" value={skillSpent()} />
          <Counter label="Изъяны" value={hindrancePoints().total} cap={4} warn={hindrancePoints().total > 4} />
          <Counter label="Черты" value={c().edges.length} cap={1} />
        </div>
